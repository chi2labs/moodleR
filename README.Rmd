...
The goal of moodleR is to facilitate access to and manipulating of Moodle&trade; data for learning analytics practitioners. Moodle is a widely used open source learning management system (LMS). For more information about Moodle go to [www.moodle.org](http://www.moodle.org). 
